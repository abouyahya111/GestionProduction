...
public interface Constantes {
	...
	/* TYPE UTILISATEUR  */
	//public static final String  UTILISATEUR_ENVRAC= "ENVRAC";
	public static final String  UTILISATEUR_EMBALLAGE= "EMBALLAGE";
	public static final String  UTILISATEUR_PRODUCTION= "PRODUCTION";
	public static final String  UTILISATEUR_SORTIE_PRODUCTION= "SORTIE PRODUCTION";
	public static final String  UTILISATEUR_SORTIE_ENVRAC= "SORTIE ENVRAC";
	...
	public static final String STATUT_TRANSFER_PRODUIT_FINI_SORTIE_ENATTENTE = "SORTIE_ENATTENTE";
	public static final String STATUT_TRANSFER_PRODUIT_FINI_SORTIE_ANNULE = "SORTIE_ANNULE";
...
/*SEQUENCEUR CODE CLASSE POUR GENERER LES CODES */
	...
	public static final String SOUS_CATEGORIE_MATIERE_PREMIERE_BOITE = "BOI001";
...
/*Etat STATISTIQUE PRODUCTION PF ET CARTON */	
				...
				/*Etats STATISTIQUE MP*/
				public static final String ETAT_MODIFIER = "MODIFIER";			
				
/* SOURCE PRODUCTION POUR SORTIE PF */	
				
				public static final String SOURCE_PRODUCTION = "PRODUCTION";
				public static final String SOURCE_ENVRAC = "ENVRAC";
				public static final String SOURCE_MIXTE = "MIXTE";
