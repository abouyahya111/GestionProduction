...
if(tableCoutMP.getRowCount()==0)
{
	...
	return;
      ...
      //  row = spreadsheet.createRow(tableCoutMP.getRowCount()+4); 
        ...
        row.createCell(7).setCellFormula("SUM(H"+(tableCoutMP.getRowCount() +16)+":H"+(tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount()+16)+")"); 

        row.createCell(15).setCellFormula("SUM(E"+(tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount()+17)+":H"+(tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount()+17)+")");
   ...
   //     row = spreadsheet.createRow(tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount() + 3); 
        ...
        row.createCell(7).setCellFormula("SUM(H"+(tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount()+21)+":H"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount()+20)+")"); 

        row.createCell(15).setCellFormula("SUM(E"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount()+21)+":H"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount()+21)+")");
...
HSSFCell dataCell1 = (HSSFCell) row.createCell(j);
        ...
        row.createCell(7).setCellFormula("SUM(H"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount() + 23)+":H"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount() + tableCoutEmployeEmballage.getRowCount() + 23)+")"); 

        row.createCell(15).setCellFormula("SUM(E"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount() + tableCoutEmployeEmballage.getRowCount() + 24)+":H"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount() + tableCoutEmployeEmballage.getRowCount() + 24)+")");
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////      
	...
	public static void tabletoexcelDetailOFCarton(JXTable tableCoutMP  ,JXTable tableCoutEmployeProduction ,String titre , String titrefeuille ,String CodeArticle,String Libelle, String DateProduction, String Prix,String QuantiteReel,String CoutTotal)
	{
...
if(tableCoutMP.getRowCount()==0)
{
	...
	return;
        ...
        */
        ...
        row = spreadsheet.createRow(tableCoutMP.getRowCount()+16);    
        row.createCell(0).setCellValue("Cout Emplaoye Production  ");
   ...
   //     row = spreadsheet.createRow(tableCoutMP.getRowCount() + tableCoutEmplaoyeGenerique.getRowCount() + 3); 
        ...
        for (int i = 0; i < tableCoutEmployeProduction.getRowCount(); i++) {
        	row = spreadsheet.createRow(i +tableCoutMP.getRowCount() +17);
            for (int j = 0; j < tableCoutEmployeProduction.getColumns().size(); j++) {
                if (tableCoutEmployeProduction.getValueAt(i, j) != null) {
        ...
        row = spreadsheet.createRow(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() +18);
        row.createCell(0).setCellValue("Total Cout Emplaoye Production  ");   
       
        row.createCell(4).setCellFormula("SUM(E"+(tableCoutMP.getRowCount() +18)+":E"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() +18)+")");  
        row.createCell(5).setCellFormula("SUM(F"+(tableCoutMP.getRowCount() +18)+":F"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() +18)+")"); 
        row.createCell(6).setCellFormula("SUM(G"+(tableCoutMP.getRowCount() +18)+":G"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() +18)+")");
        row.createCell(7).setCellFormula("SUM(H"+(tableCoutMP.getRowCount() +18)+":H"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() +18)+")");
       
        row.createCell(15).setCellFormula("SUM(E"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() +19)+":H"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount() +19)+")");
      ...
      //////////////////////////////////////////////////////////////////////// Cout Total /////////////////////////////////////////////////////////////////////////////////  
        ...
        row = spreadsheet.createRow(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount()  + 20);
        row.createCell(0).setCellValue("Cout Total ");  
       row.createCell(15).setCellFormula("SUM(P"+(tableCoutMP.getRowCount()+14)+":P"+(tableCoutEmployeProduction.getRowCount() + tableCoutMP.getRowCount()  + 19)+")"); 
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////      
	...
	public static void tabletoexcelListeCodeMPParArticlePFF(JXTable table , String titre , String titrefeuille)
	{
...
if(table.getRowCount()==0)
{
    ...
    /*    org.apache.poi.ss.usermodel.Font font =  workbook.createFont();
        ...
        for (int i = 0; i < table.getRowCount(); i++) {
            ...
            for (int j = 0; j < table.getColumns().size(); j++) {
                if (table.getValueAt(i, j) != null) {
                 if(table.getValueAt(i, j).toString().contains("."))
                 {
            ...
            for (int j = 0; j < table.getColumnCount(); j++) {
                if (table.getValueAt(i, j) != null) {
                	...
                	if(j>1)
                	{
                    	...
                    	dataCell1.getCellStyle().setDataFormat(HSSFDataFormat.getBuiltinFormat("#,##0.0000"));
...
if(table.getRowCount()==0)
{
	...
	public static void tabletoexcelListSituationManquePlus(JXTable table , String titre , String titrefeuille )
	{
