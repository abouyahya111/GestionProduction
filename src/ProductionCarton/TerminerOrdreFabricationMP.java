...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
				  		...
				  		btnChercherOF.setIcon(new ImageIcon(CreerOrdreFabricationMP.class.getResource("/img/chercher.png")));
		  		     	...
		  		     	public void actionPerformed(ActionEvent e) {
									...
									if(reponse == JOptionPane.YES_OPTION )
			  		     			...
			  		     			BigDecimal coutTotal=coutTotalEmploye.add(coutTotalDechet).add(coutTotalMP);
			  		     		...
			  		     		/* délai des employés Emabalege*/
				  		     		...
				  		     		coutTotal=coutTotalEmploye.add(coutTotalDechet).add(coutTotalMP);
	...
	//	scrollPane_1.setViewportView(tableEmploye);
		...
		add(titledSeparator_1);
				  		...
				  		checkEnpanneproductioncarton.setBounds(809, 309, 76, 23);
	...
	int nbrEmployeTravaill=0;
		  int i=0;
			...
			{	
				...
				Object []ligne={detailProductionMP.getEmploye().getId(),detailProductionMP.getEmploye().getMatricule(),detailProductionMP.getEmploye().getNomafficher(),delai,heureSupp25,heureSupp50,absent,sortie,retard,panne};
