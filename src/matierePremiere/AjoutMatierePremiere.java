...
listeTypeOffre=typeOffreDAO.findAll();
       ...
       System.exit(0);
		...
		this.add(scrollPane);
		  		...
		  		if(mp.getPrixByYear(DateUtils.getAnnee(dateChooserModifier.getDate())).compareTo(BigDecimal.ZERO)==0)
		  		{
		  			listDetailTransferStockMP=detailTransferMPDAO.findAllTransferStockMPByMPByStatut(mp, Constantes.ETAT_TRANSFER_STOCK_AJOUT);
		  			listDetailTransferStockMPSortie=detailTransferMPDAO.findAllTransferStockMPByMPByStatut(mp, Constantes.ETAT_TRANSFER_STOCK_SORTIE);
						...
						}else
						{
							...
							DetailTransferStockMP detailTransferStockMP= listDetailTransferStockMP.get(d);
								...
								listeStatistiqueFinanciereMP=statistiqueFinanciereMPDAO.findAll();
			  		     		...
			  		     		if(statistiqueFinanciaireMPTmp!=null)
			  		     		{
			  		     			...
			  		     			{
			  		     				statistiqueFinanciaireMP.setStockEnVrac(statistiqueFinanciaireMPTmp.getStockEnVrac().add(detailTransferStockMP.getQuantite().multiply(mp.getPrixByYear(DateUtils.getAnnee(dateChooserModifier.getDate())))));
			  		     				statistiqueFinanciaireMP.setStockEmballage(statistiqueFinanciaireMPTmp.getStockEmballage());
			  		     			}else
			  		     			{
			  		     				statistiqueFinanciaireMP.setStockEmballage(statistiqueFinanciaireMPTmp.getStockEmballage().add(detailTransferStockMP.getQuantite().multiply(mp.getPrixByYear(DateUtils.getAnnee(dateChooserModifier.getDate())))));
			  		     			...
			  		     			statistiqueFinanciaireMP.setCodeTransfer(detailTransferStockMP.getTransferStockMP().getCodeTransfer());
			  		     			statistiqueFinanciaireMP.setDate(new Date());
			  		     			statistiqueFinanciaireMP.setDateOperation(detailTransferStockMP.getTransferStockMP().getDateTransfer());
			  		     			...
			  		     			statistiqueFinanciaireMP.setCoutReception((detailTransferStockMP.getQuantite().multiply(mp.getPrixByYear(DateUtils.getAnnee(dateChooserModifier.getDate())))).add(statistiqueFinanciaireMPTmp.getCoutReception()) );
						 ...
						 for(int d=0;d<listDetailTransferStockMPSortie.size();d++)
						 {
							DetailTransferStockMP detailTransferStockMP= listDetailTransferStockMPSortie.get(d);
								...
								listeStatistiqueFinanciereMP=statistiqueFinanciereMPDAO.findAll();
			  		     		...
			  		     		if(statistiqueFinanciaireMPTmp!=null)
			  		     		{
			  		     			...
			  		     			if(detailTransferStockMP.getMatierePremier().getCategorieMp().getSubCategorieMp().getCode().equals(Constantes.SOUS_CATEGORIE_MATIERE_PREMIERE_THE))
			  		     			{
			  		     				statistiqueFinanciaireMP.setStockEnVrac(statistiqueFinanciaireMPTmp.getStockEnVrac().subtract(detailTransferStockMP.getQuantite().multiply(mp.getPrixByYear(DateUtils.getAnnee(dateChooserModifier.getDate())))));
			  		     				statistiqueFinanciaireMP.setStockEmballage(statistiqueFinanciaireMPTmp.getStockEmballage());
			  		     			}else
			  		     			{
			  		     				statistiqueFinanciaireMP.setStockEmballage(statistiqueFinanciaireMPTmp.getStockEmballage().subtract(detailTransferStockMP.getQuantite().multiply(mp.getPrixByYear(DateUtils.getAnnee(dateChooserModifier.getDate())))));
			  		     				statistiqueFinanciaireMP.setStockEnVrac(statistiqueFinanciaireMPTmp.getStockEnVrac());
			  		     			...
			  		     			statistiqueFinanciaireMP.setCoutSortie((detailTransferStockMP.getQuantite().multiply(mp.getPrixByYear(DateUtils.getAnnee(dateChooserModifier.getDate())))).add(statistiqueFinanciaireMPTmp.getCoutSortie()));
			  		     			statistiqueFinanciaireMP.setCoutTransfertMPPF(statistiqueFinanciaireMPTmp.getCoutTransfertMPPF());
			  		     			statistiqueFinanciaireMP.setCoutVente(statistiqueFinanciaireMPTmp.getCoutVente());
			  		     			statistiqueFinanciaireMP.setCoutRetour(statistiqueFinanciaireMPTmp.getCoutRetour());
			  		     			statistiqueFinanciaireMP.setEtat(Constantes.ETAT_TRANSFER_STOCK_SORTIE);
			  		     			statistiqueFinanciaireMP.setEtatTransfer(Constantes.ETAT_TRANSFER_STOCK_SORTIE);
			  		     			statistiqueFinanciereMPDAO.add(statistiqueFinanciaireMP);	 
