...
formeParBox.setForme(forme);
	...
	void ChargerCombobox()
	{
		...
		for(int i=0;i<listSousCategorie.size();i++)
		{
			...
			if(listSousCategorie.get(i).getCode().equals(SOUS_CATEGORIE_MATIERE_PREMIERE_BOX) || listSousCategorie.get(i).getCode().equals(SOUS_CATEGORIE_MATIERE_PREMIERE_BOX_METALIQUE) || listSousCategorie.get(i).getCode().equals(SOUS_CATEGORIE_MATIERE_PREMIERE_BOITE))
			{
