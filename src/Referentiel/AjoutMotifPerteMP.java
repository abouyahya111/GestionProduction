				  		   ...
				  		   add(layeredPane);
				  		   		...
				  		   		afficher_tableTypeVente(listMotifPerteMP);
			  								 ...
			  								 int reponse = JOptionPane.showConfirmDialog(null, "Vous voulez vraiment Modifier le Motif de Perte ?", 
			  											...
			  											
			  										{
			  											...
			  											if(trouve==false)
			  											{
				  											...
				  											charger();
						  		  							JOptionPane.showMessageDialog(null, "Motif de Perte modifier avec succée ");
						  		  							initialiser();
				  		   			...
				  		   			btnAjouter.addActionListener(new ActionListener() {
				  		   				...
				  		   				JOptionPane.showMessageDialog(null, "Motif de Perte ajouté avec succée SVP !!!!","Succée", JOptionPane.INFORMATION_MESSAGE);
				  		   				initialiser();
				  		   				...
				  		   				public void actionPerformed(ActionEvent arg0) {
				  		   					...
				  		   					if(table.getSelectedRow()!=-1)
				  		   					{
		  											...
		  											
		  										{
		  											...
		  											charger();
		  											JOptionPane.showMessageDialog(null, " Motif de Perte supprimer avec succée ");
				  		  							initialiser();
