...
import util.ComparateurProductionArticleParMois;
	...
	public ProductionEnvracParMois() {
       ...
       System.exit(0);
		...
		btnAfficherStock.addActionListener(new ActionListener() {
			...
			listeObjectInitialEnVrac=detailTransferMPDAO.listeInitialEnVrac(Integer.valueOf(annee), Constantes.ETAT_TRANSFER_STOCK_INITIAL,magasin, subCategorieMp);
			...
			Collections.sort(listProductionArticleParMois, new ComparateurProductionArticleParMois());
