       ...
       System.exit(0);
        ...
        try{
		  ...
		  table.setModel(new DefaultTableModel(
		  	...
		  	new String[] {
		  			"Operation",	"Alimentation", "Stock Emballage", "Stock En Vrac", "Stock Production", "Cout Employee","Stock Reception","Stock Sortie","Stock PF", "Ecart"
		  	}
		  ));
...
void CalculerCoutProductionParArticle()
{
	...
	dfDecimal.setGroupingUsed(true);
		...
		{	
			...
			ecart=statistiqueFinanciaireMP.getAlimentation().subtract(statistiqueFinanciaireMP.getStockEmballage()).subtract(statistiqueFinanciaireMP.getStockEnVrac()).subtract(statistiqueFinanciaireMP.getCoutProduction().add(statistiqueFinanciaireMP.getCoutProductionCarton())).add(statistiqueFinanciaireMP.getCoutEmployeeProduction().add(statistiqueFinanciaireMP.getCoutEmployeeCarton()).add(statistiqueFinanciaireMP.getCoutReception())).subtract(statistiqueFinanciaireMP.getCOUTPF().add(statistiqueFinanciaireMP.getCoutSortie()));
			
			

					 Object []ligne={statistiqueFinanciaireMP.getDateOperation(), statistiqueFinanciaireMP.getEtat(), dfDecimal.format(statistiqueFinanciaireMP.getAlimentation().setScale(2, RoundingMode.HALF_UP)) ,dfDecimal.format(statistiqueFinanciaireMP.getStockEmballage().setScale(2, RoundingMode.HALF_UP)),dfDecimal.format(statistiqueFinanciaireMP.getStockEnVrac().setScale(2, RoundingMode.HALF_UP)),dfDecimal.format(statistiqueFinanciaireMP.getCoutProduction().setScale(2, RoundingMode.HALF_UP)),dfDecimal.format(statistiqueFinanciaireMP.getCoutEmployeeProduction().setScale(2, RoundingMode.HALF_UP)),dfDecimal.format(statistiqueFinanciaireMP.getCoutReception().setScale(2, RoundingMode.HALF_UP)),dfDecimal.format(statistiqueFinanciaireMP.getCoutProductionCarton().setScale(2, RoundingMode.HALF_UP)),dfDecimal.format(statistiqueFinanciaireMP.getCoutEmployeeCarton().setScale(2, RoundingMode.HALF_UP)),dfDecimal.format(statistiqueFinanciaireMP.getCoutSortie().setScale(2, RoundingMode.HALF_UP)),dfDecimal.format(statistiqueFinanciaireMP.getCOUTPF().setScale(2, RoundingMode.HALF_UP)),dfDecimal.format(ecart.setScale(2, RoundingMode.HALF_UP))};
	...
	void intialiserTableau(){
		 modeleMP =new DefaultTableModel(
			     	...
			     	new String[] {
			     			"Date",	"Operation",	"Alimentation", "Stock Emballage", "Stock En Vrac", "Stock Production", "Cout Employee","Stock Reception","Stock Production carton","Cout Employee carton","Stock Sortie", "Stock PF", "Ecart"
			     			}
			     ) {
			     	boolean[] columnEditables = new boolean[] {
