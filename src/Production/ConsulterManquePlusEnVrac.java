...
public class ConsulterManquePlusEnVrac extends JLayeredPane implements Constantes{
	 ...
	 */
	public ConsulterManquePlusEnVrac() {
		setOpaque(true);
        ...
        try{
            imgInit= new ImageIcon(this.getClass().getResource("/img/init.png"));
				  		   ...
				  		   modeleMP =new DefaultTableModel(
					  		     	...
					  		     	new String[] {
					  		     			"Code MP","Matiere Premiere","Fournisseur","Quantite Total Manque"," Quantite Total Plus"
					  		     	}
					  		     ) {
					      ...
					      //   intialiserTableau2();
				  		      ...
				  		      modeleMP1 =new DefaultTableModel(
				  			     	...
				  			     	new String[] {
				  			     			"OF","Code MP","Matiere Premiere","Fournisseur", "Quantité Manque","Quantite Plus"
				  			     	}
				  			     ) {
				  			     	boolean[] columnEditables = new boolean[] {
		...
		layeredPane.add(lblMp);
		 ...
		 button_1.addActionListener(new ActionListener() {
		 	...
		 	if(listDetailManqueDechetFournisseurImprimer.size()!=0)
		 	{
				...
				JasperUtils.imprimerDetailManquePlusEnVrac(listDetailManqueDechetFournisseurImprimer,parameters);
...
void afficher_tableMP(List<Object[]> listEtatMontantPF)
	{
		...
		if(mp.getCategorieMp().getSubCategorieMp().getCode().equals(Constantes.SOUS_CATEGORIE_MATIERE_PREMIERE_THE))
		{
			 ...
			 Object []ligne={object[0],object[1],object[2],NumberFormat.getNumberInstance(Locale.FRANCE).format(object[3]),NumberFormat.getNumberInstance(Locale.FRANCE).format(object[5])};
