...
JOptionPane.showMessageDialog(null, "Veuillez Selectionner Depot et Magasin  SVP","Erreur",JOptionPane.ERROR_MESSAGE);
		...
		layeredPane.add(combodepot);
		 ...
		 button_1.setBounds(329, 696, 104, 31);
		 add(button_1);
		...
		add(differencemontantplusmoins);
			...
			btnBonFrais.setBounds(199, 696, 104, 31);
			...
			button.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					if(tableSituationManqueEnVrac.getRowCount()!=0)
					{
						...
						String titre="Situation Manque Et Plus Et Dechet En Vrac";
			    		String titrefeuilleexcel="Situation Manque Et Plus Et Dechet En Vrac";
			    		ExporterTableVersExcel.tabletoexcelListSituationManquePlus (tableSituationManqueEnVrac, titre,titrefeuilleexcel);
			...
			button.setBounds(456, 696, 104, 31);
...
void afficher_tableMP(List<SituationManquePlusEnVrac> listSituationManquePlusEtMoinsEnVrac)
 ...
 totalDechetCalculer=totalDechetCalculer.add(SituationManquePlusEnVrac.getQuantDechet());
			...
			SituationManquePlusEnVrac.setMontantPlus(SituationManquePlusEnVrac.getPrixUnitaire().multiply(SituationManquePlusEnVrac.getQuantiteManquanteFrPlus()));
					 ...
					 Object []ligne={SituationManquePlusEnVrac.getProdcutionCM().getNumOF(),SituationManquePlusEnVrac.getProdcutionCM().getDate(),SituationManquePlusEnVrac.getProdcutionCM().getArticles().getLiblle(),SituationManquePlusEnVrac.getMatierePremier().getNom(),SituationManquePlusEnVrac.getMatierePremier().getCategorieMp().getNom(),SituationManquePlusEnVrac.getFournisseurMP().getCodeFournisseur(),dfDecimal.format(SituationManquePlusEnVrac.getQuantExistante()),dfDecimal.format(SituationManquePlusEnVrac.getQuantCharge()),dfDecimal.format(SituationManquePlusEnVrac.getQuantChargeSupp()),dfDecimal.format(SituationManquePlusEnVrac.getQuantConsomme()),dfDecimal.format(SituationManquePlusEnVrac.getQuantiteOffre()),dfDecimal.format(SituationManquePlusEnVrac.getQuantReste()), dfDecimal.format(SituationManquePlusEnVrac.getQuantiteManquanteFrPlus()),dfDecimal.format(SituationManquePlusEnVrac.getQuantiteManquante()),dfDecimal.format(SituationManquePlusEnVrac.getPrixUnitaire()),dfDecimal.format(SituationManquePlusEnVrac.getPrixUnitaire().multiply(SituationManquePlusEnVrac.getQuantiteManquanteFrPlus())),dfDecimal.format(SituationManquePlusEnVrac.getPrixUnitaire().multiply(SituationManquePlusEnVrac.getQuantiteManquante())) };
