	 ...
	 private CoutHorsProdEnAttentDAO CoutHorsProdEnAttentDAO;
		...
		JComboBox comboArticle = new JComboBox();
		 ...
		 private Map< String, Articles> mapCodeArticle= new HashMap<>();
			...
			private JTextField txtCoutTotalPrimeGenerique;
			private JTextField txtCoutTotalPrimeProduction;
			private JTextField txtCoutTotalPrimeEmballage;
     ...
     afficher_tableProd(listProduction);
		...
		btnImprimer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for(int i=0;i<listEmployeGesnerique.size();i++)
				{
					...
					if(!listEmployeGesnerique.get(i).getEmploye().isSalarie())
					{
						TotalHeuresProduction=listEmployeGesnerique.get(i).getTotalHeuresProduction();
						
						coutTotalEmployeGenerique=coutTotalEmployeGenerique.add(( (listEmployeGesnerique.get(i).getDelaiEmploye().divide(listEmployeGesnerique.get(i).getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure())).multiply(listEmployeGesnerique.get(i).getCoutHoraire()).setScale(4, RoundingMode.HALF_UP));
						//coutTotalEmployeGenerique=coutTotalEmployeGenerique.add((listEmployeGesnerique.get(i).getDelaiEmploye().multiply(listEmployeGesnerique.get(i).getCoutHoraire())).setScale(4, RoundingMode.HALF_UP));
						
						coutTotalSupp25EmployeGenerique=coutTotalSupp25EmployeGenerique.add(((listEmployeGesnerique.get(i).getHeureSupp25().divide(listEmployeGesnerique.get(i).getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure())).multiply(listEmployeGesnerique.get(i).getCoutHoraireSupp25()).setScale(4, RoundingMode.HALF_UP));
						...
						coutTotalSupp50EmployeGenerique=coutTotalSupp50EmployeGenerique.add((listEmployeGesnerique.get(i).getHeureSupp50().divide(listEmployeGesnerique.get(i).getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure()).multiply(listEmployeGesnerique.get(i).getCoutHoraireSupp50()).setScale(4, RoundingMode.HALF_UP));
						
						if(listEmployeGesnerique.get(i).getRemise()!=null)
						{
							coutTotalPrimeEmployeGenerique= coutTotalPrimeEmployeGenerique.add((((listEmployeGesnerique.get(i).getRemise().divide(new BigDecimal(8), 4, RoundingMode.HALF_UP)).multiply(listEmployeGesnerique.get(i).getDelaiEmploye())).divide(listEmployeGesnerique.get(i).getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure())) ;
						}
					}
				...
				TotalCoutEmployerResponsableParProduction=TotalCoutEmployerResponsableParProduction.add(coutTotalEmployeGenerique);
				TotalCoutEmployerSupp25ResponsableParProduction=TotalCoutEmployerSupp25ResponsableParProduction.add( ((coutTotalSupp25EmployeGenerique).divide(TotalHeuresProduction, 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure()) );
				TotalCoutEmployerSupp50ResponsableParProduction=TotalCoutEmployerSupp50ResponsableParProduction.add( ((coutTotalSupp50EmployeGenerique).divide(TotalHeuresProduction, 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure()) );
				TotalCoutPrimeEmployerResponsableParProduction=TotalCoutPrimeEmployerResponsableParProduction.add(coutTotalPrimeEmployeGenerique);
				
				
				for(int j=0;j<listEmployeProduction.size();j++)
				{
					if(!listEmployeProduction.get(j).getEmploye().isSalarie())
					{
				...
				{
					if(!listCoutHorsProductionEnAttent.get(j).getEmploye().isSalarie())
					{
						...
						coutTotalSupp50EmployeProduction=coutTotalSupp50EmployeProduction.add(listCoutHorsProductionEnAttent.get(j).getCoutHoraire50().multiply(listCoutHorsProductionEnAttent.get(j).getHeure50()));
						 ...
						 BigDecimal remise=BigDecimal.ZERO;
	  		     			if(listCoutHorsProductionEnAttent.get(j).getTypeResEmploye().getCode().equals(TYPE_EMPLOYE_MAIN_OUVRE_PRODUCTION))
	  		     			{
	  		     				remise=mapParametre.get(PARAMETRE_CODE_REMISE_EQUIPE_PRODUCTION);
	  		     			}
								
	  		     			else if(listCoutHorsProductionEnAttent.get(j).getTypeResEmploye().getCode().equals(TYPE_EMPLOYE_MAIN_OUVRE_EN_VRAC))
	  		     			{
	  		     				remise=mapParametre.get(PARAMETRE_CODE_REMISE_EQUIPE_EMBALAGE);
	  		     			}
								
							
							 remise=(remise.divide(new BigDecimal(8), 6, RoundingMode.HALF_UP)).multiply(listCoutHorsProductionEnAttent.get(j).getDelaiEmploye());
							 
							 coutTotalPrimeEmployeProduction=coutTotalPrimeEmployeProduction.add(remise); 
					}
					...
					for(int d=0;d<listEmployeProduction.size();d++)
					{
						...
						if(listEmployeProduction.get(d).getEmploye().getId()==listCoutHorsProductionEnAttent.get(t).getEmploye().getId())
						{
							...
							listEmployeProduction.get(d).setCoutSupp50 (listEmployeProduction.get(d).getCoutSupp50().add(listCoutHorsProductionEnAttent.get(t).getCoutSupp50()));
							 ...
							 BigDecimal remise=BigDecimal.ZERO;
		  		     			if(listCoutHorsProductionEnAttent.get(t).getTypeResEmploye().getCode().equals(TYPE_EMPLOYE_MAIN_OUVRE_PRODUCTION))
		  		     			{
		  		     				remise=mapParametre.get(PARAMETRE_CODE_REMISE_EQUIPE_PRODUCTION);
		  		     			}
									
		  		     			else if(listCoutHorsProductionEnAttent.get(t).getTypeResEmploye().getCode().equals(TYPE_EMPLOYE_MAIN_OUVRE_EN_VRAC))
		  		     			{
		  		     				remise=mapParametre.get(PARAMETRE_CODE_REMISE_EQUIPE_EMBALAGE);
		  		     			}
									
								
								 remise=(remise.divide(new BigDecimal(8), 6, RoundingMode.HALF_UP)).multiply(listCoutHorsProductionEnAttent.get(t).getDelaiEmploye());
								 
							 
								 listEmployeProduction.get(d).setRemise (listEmployeProduction.get(d).getRemise().add(remise));
				...
				for(int j=0;j<listEmployeEmballage.size();j++)
				{
					...
					if(!listEmployeEmballage.get(j).getEmploye().isSalarie())
					{
				...
				txtCoutTotalPrimeEmballage.setText(dfDecimal.format(coutTotalPrimeEmployeEmballage.setScale(4, RoundingMode.HALF_UP))+"");
				txtCoutTotalPrimeGenerique.setText(dfDecimal.format(TotalCoutPrimeEmployerResponsableParProduction.setScale(4, RoundingMode.HALF_UP))+"");
				txtCoutTotalPrimeProduction.setText(dfDecimal.format(coutTotalPrimeEmployeProduction.setScale(4, RoundingMode.HALF_UP))+"");
				txtCoutTotalEmployeGenerique.setText(dfDecimal.format(TotalCoutEmployerResponsableParProduction.setScale(4, RoundingMode.HALF_UP))+"");
				txtCoutTotalEmployeProduction.setText(dfDecimal.format(coutTotalEmployeProduction.setScale(4, RoundingMode.HALF_UP))+"");
				txtCoutTotalEmployeEmballage.setText(dfDecimal.format(coutTotalEmployeEmballage.setScale(4, RoundingMode.HALF_UP))+"");
				txtTotalCoutDechetMP.setText(dfDecimal.format(coutTotalDechetMP.setScale(4, RoundingMode.HALF_UP))+"");
				txtTotalCoutOffreMP.setText(dfDecimal.format(coutTotalOffreMP.setScale(4, RoundingMode.HALF_UP))+"");
				txtTotalCoutDechetFournisseurMP.setText(dfDecimal.format(coutTotalDechetFournisseurMP.setScale(4, RoundingMode.HALF_UP))+"");
				txtTotalCoutQuantiteConsommeMP.setText(dfDecimal.format(coutTotalCoutQuantiteConsommeMP.setScale(4, RoundingMode.HALF_UP))+"");
				txttotalcoutsupp25employeEmballage.setText(dfDecimal.format(coutTotalSupp25EmployeEmballage.setScale(4, RoundingMode.HALF_UP))+"");
				txttotalcoutsupp50employeEmballage.setText(dfDecimal.format(coutTotalSupp50EmployeEmballage.setScale(4, RoundingMode.HALF_UP))+"");
				txttotalcoutsupp25employegenerique.setText(dfDecimal.format(TotalCoutEmployerSupp25ResponsableParProduction.setScale(4, RoundingMode.HALF_UP))+"");
				txttotalcoutsupp50employegenerique.setText(dfDecimal.format(TotalCoutEmployerSupp50ResponsableParProduction.setScale(4, RoundingMode.HALF_UP))+"");
				txttotalcoutsupp25employeProduction.setText(dfDecimal.format(coutTotalSupp25EmployeProduction.setScale(4, RoundingMode.HALF_UP))+"");
				txttotalcoutsupp50employeProduction.setText(dfDecimal.format(coutTotalSupp50EmployeProduction.setScale(4, RoundingMode.HALF_UP))+"");
				txtTotalCoutManquanteMP.setText(dfDecimal.format(coutTotalManquanteMP.setScale(4, RoundingMode.HALF_UP))+"");
				
				txtCoutTotalMP.setText(dfDecimal.format(coutTotalCoutQuantiteConsommeMP.setScale(4, RoundingMode.HALF_UP).add(coutTotalDechetMP.setScale(4, RoundingMode.HALF_UP).add(coutTotalDechetFournisseurMP.setScale(4, RoundingMode.HALF_UP)).add(coutTotalOffreMP.setScale(4, RoundingMode.HALF_UP).add(coutTotalManquanteMP.setScale(4, RoundingMode.HALF_UP)))))+"");

				
				afficher_tableMP(listCoutMP);
				afficher_tableEmployeproduction(listEmployeProduction);
				afficher_tableEmployeGenerique(listEmployeGesnerique , production);
				afficher_tableEmployeEmballage(listEmployeEmballage);
				
				
				
				txtCoutTotal.setText( dfDecimal.format((coutTotalCoutQuantiteConsommeMP.setScale(4, RoundingMode.HALF_UP).add(coutTotalDechetMP.setScale(4, RoundingMode.HALF_UP).add(coutTotalDechetFournisseurMP.setScale(4, RoundingMode.HALF_UP)).add(coutTotalOffreMP.setScale(4, RoundingMode.HALF_UP).add(coutTotalManquanteMP.setScale(4, RoundingMode.HALF_UP))))).add(TotalCoutEmployerResponsableParProduction.setScale(4, RoundingMode.HALF_UP).add(TotalCoutEmployerSupp25ResponsableParProduction.setScale(4, RoundingMode.HALF_UP)).add(TotalCoutEmployerSupp50ResponsableParProduction.setScale(4, RoundingMode.HALF_UP))).add(coutTotalEmployeProduction.setScale(4, RoundingMode.HALF_UP).add(coutTotalSupp25EmployeProduction.setScale(4, RoundingMode.HALF_UP)).add(coutTotalSupp50EmployeProduction.setScale(2, RoundingMode.HALF_UP))).add(coutTotalEmployeEmballage.setScale(4, RoundingMode.HALF_UP).add(coutTotalSupp25EmployeEmballage.setScale(4, RoundingMode.HALF_UP).add(coutTotalSupp50EmployeEmballage.setScale(4, RoundingMode.HALF_UP)).add(coutTotalPrimeEmployeEmballage.setScale(4, RoundingMode.HALF_UP).add(coutTotalPrimeEmployeProduction.setScale(4, RoundingMode.HALF_UP).add(TotalCoutPrimeEmployerResponsableParProduction.setScale(4, RoundingMode.HALF_UP)))))))+"");
				txtPrix.setText(((coutTotalCoutQuantiteConsommeMP.setScale(4, RoundingMode.HALF_UP).add(coutTotalDechetMP.setScale(4, RoundingMode.HALF_UP).add(coutTotalDechetFournisseurMP.setScale(4, RoundingMode.HALF_UP)).add(coutTotalOffreMP.setScale(4, RoundingMode.HALF_UP).add(coutTotalManquanteMP.setScale(4, RoundingMode.HALF_UP))))).add(TotalCoutEmployerResponsableParProduction.setScale(4, RoundingMode.HALF_UP).add(TotalCoutEmployerSupp25ResponsableParProduction.setScale(4, RoundingMode.HALF_UP)).add(TotalCoutEmployerSupp50ResponsableParProduction.setScale(4, RoundingMode.HALF_UP))).add(coutTotalEmployeProduction.setScale(4, RoundingMode.HALF_UP).add(coutTotalSupp25EmployeProduction.setScale(4, RoundingMode.HALF_UP).add(coutTotalSupp50EmployeProduction.setScale(4, RoundingMode.HALF_UP)))).add(coutTotalEmployeEmballage.setScale(4, RoundingMode.HALF_UP).add(coutTotalSupp25EmployeEmballage.setScale(4, RoundingMode.HALF_UP).add(coutTotalSupp50EmployeEmballage.setScale(4, RoundingMode.HALF_UP).add(coutTotalPrimeEmployeEmballage.setScale(4, RoundingMode.HALF_UP).add(coutTotalPrimeEmployeProduction.setScale(4, RoundingMode.HALF_UP)).add(TotalCoutPrimeEmployerResponsableParProduction.setScale(4, RoundingMode.HALF_UP))))))) .divide(production.getQuantiteReel(), 4, RoundingMode.HALF_UP)+"");
		...
		add(btnImprimer);
		 ...
		 // tableEmployeProduction.setModel(modeleEmployeProd);
		  ...
		  txtCoutTotalEmployeGenerique.setBounds(1340, 399, 111, 30);
		  ...
		  txtCoutTotalEmployeProduction.setBounds(1359, 601, 105, 24);
		  ...
		  txtCoutTotalEmployeEmballage.setBounds(1336, 767, 111, 30);
		  ...
		  txttotalcoutsupp50employegenerique.setBounds(1229, 399, 105, 30);
		  ...
		  txttotalcoutsupp25employegenerique.setBounds(1114, 399, 111, 30);
		  ...
		  txttotalcoutsupp50employeProduction.setBounds(1252, 600, 105, 25);
		  ...
		  txttotalcoutsupp25employeProduction.setBounds(1127, 600, 122, 25);
		  ...
		  txttotalcoutsupp50employeEmballage.setBounds(1212, 767, 118, 30);
		  ...
		  txttotalcoutsupp25employeEmballage.setBounds(1100, 767, 105, 30);
		  ...
		  txtCoutTotalPrimeGenerique = new JTextField();
		  txtCoutTotalPrimeGenerique.setEditable(false);
		  txtCoutTotalPrimeGenerique.setColumns(10);
		  txtCoutTotalPrimeGenerique.setBounds(1458, 399, 111, 30);
		  add(txtCoutTotalPrimeGenerique);
		  ...
		  txtCoutTotalPrimeProduction.setBounds(1464, 601, 105, 24);
		  add(txtCoutTotalPrimeProduction);
		  
		  txtCoutTotalPrimeEmballage = new JTextField();
		  txtCoutTotalPrimeEmballage.setEditable(false);
		  txtCoutTotalPrimeEmballage.setColumns(10);
		  txtCoutTotalPrimeEmballage.setBounds(1458, 767, 111, 30);
		  add(txtCoutTotalPrimeEmballage);
...
void afficher_tableEmployeGenerique(List<DetailProdRes> listDetailProdGenerique , Production production)
{
	intialiserTableauEmployeGenerique();;
	DecimalFormatSymbols symbols = new DecimalFormatSymbols();
	symbols.setGroupingSeparator(' ');
	...
	BigDecimal prime=BigDecimal.ZERO;
		...
		{	
			...
			if(detailemployegen.getRemise()!=null)
			{
				if(detailemployegen.getTotalHeuresProduction()!=null)
				{
					if(detailemployegen.getTotalHeuresProduction().compareTo(BigDecimal.ZERO)!=0)
					{
						
						prime=	(((detailemployegen.getRemise().divide(new BigDecimal(8), 4, RoundingMode.HALF_UP)).multiply(detailemployegen.getDelaiEmploye())).divide(detailemployegen.getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure());
			...
			Object []ligne={detailemployegen.getEmploye().getNom(),dfDecimal.format( (detailemployegen.getDelaiEmploye().divide(detailemployegen.getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure())), dfDecimal.format((detailemployegen.getHeureSupp25().divide(detailemployegen.getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure())),dfDecimal.format((detailemployegen.getHeureSupp50().divide(detailemployegen.getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure())),dfDecimal.format(((detailemployegen.getHeureSupp25().divide(detailemployegen.getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure())).multiply(detailemployegen.getCoutHoraireSupp25())),dfDecimal.format((detailemployegen.getHeureSupp50().divide(detailemployegen.getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure()).multiply(detailemployegen.getCoutHoraireSupp50())),dfDecimal.format(( (detailemployegen.getDelaiEmploye().divide(detailemployegen.getTotalHeuresProduction(), 4, RoundingMode.HALF_UP)).multiply(production.getNbreHeure())).multiply(detailemployegen.getCoutHoraire()).setScale(4, RoundingMode.HALF_UP)),dfDecimal.format( prime.setScale(4, RoundingMode.HALF_UP))};
...
void afficher_tableEmployeEmballage(List<DetailProdGen> listEmployeEmballage)
{
	...
	BigDecimal prime=BigDecimal.ZERO;
		...
		{	
			...
			if(detailemployeEmballage.getRemise()!=null)
			{
				prime=detailemployeEmballage.getRemise();
			}
			Object []ligne={detailemployeEmballage.getEmploye().getNom(),detailemployeEmballage.getDelaiEmploye(),detailemployeEmballage.getHeureSupp25(),detailemployeEmballage.getHeureSupp50(),dfDecimal.format(detailemployeEmballage.getCoutSupp25()),dfDecimal.format(detailemployeEmballage.getCoutSupp50()),dfDecimal.format(detailemployeEmballage.getCoutTotal()),dfDecimal.format(prime.setScale(6, RoundingMode.HALF_UP))};
...
void intialiserTableauEmployeEmballage(){
	modeleEmployeEmballage =new DefaultTableModel(
		 ...
		 tableEmployeEmballage.getColumnModel().getColumn(5).setPreferredWidth(60);
		 tableEmployeEmballage.getColumnModel().getColumn(6).setPreferredWidth(60);
		 tableEmployeEmballage.getColumnModel().getColumn(7).setPreferredWidth(60);
}
...
void intialiserTableauEmployeGenerique(){
	modeleEmployeGen =new DefaultTableModel(
		 ...
		 tableEmployerGenerique.getColumnModel().getColumn(5).setPreferredWidth(60);
		 tableEmployerGenerique.getColumnModel().getColumn(6).setPreferredWidth(60);
		 tableEmployerGenerique.getColumnModel().getColumn(7).setPreferredWidth(60);
