...
public class SaisirListeEmployeGen extends JLayeredPane implements Constantes{
	...
	Utilisateur utilisateur;
	 ...
	 private JTextField txtTotalHeuresProduction;
       ...
       System.exit(0);
             ...
             listEmployer=employeDAO.findByDepot(utilisateur.getCodeDepot());
				  		...
				  		/*##################################################################
				  		     ...
				  		     btnValider.addActionListener(new ActionListener() {
				  		     	public void actionPerformed(ActionEvent arg0) {
				  		     		...
				  		     		try {
					  		     		...
					  		     		if(txtTotalHeuresProduction.getText().equals(""))	
					  		     		{
					  		     			JOptionPane.showMessageDialog(null, "Veuillez Entrer Total Des Heures De Production  SVP","Erreur",JOptionPane.ERROR_MESSAGE);
					  		     			return;
					  		     		}
					  		     		
					  		     		if(new BigDecimal( txtTotalHeuresProduction.getText()).compareTo(BigDecimal.ZERO)==0  )	
					  		     		{
					  		     			JOptionPane.showMessageDialog(null, "Veuillez Entrer Total des heures De Production Supérieur à 0 SVP","Erreur",JOptionPane.ERROR_MESSAGE);
					  		     			return;
					  		     		}
					  		     		...
					  		     		for(int i=0;i<listDetailResponsableProdTmp.size();i++)
					  		     		{
					  		     			...
					  		     			detailProdRes.setTotalHeuresProduction(new BigDecimal(txtTotalHeuresProduction.getText()));
				  		      ...
				  		      btnAjouter.addActionListener(new ActionListener() {
				  		      	public void actionPerformed(ActionEvent arg0) {
					  		     	...
					  		     	List<DetailProdRes>	listDetailResponsableProdExistant=detailProdResDAO.ListHeursDetailResponsableProdParDepot(dateProduction.getDate(), dateProduction.getDate(), depot.getId(), "");
							  		  ...
							  		  Parametre heure=parametreDAO.findByDateByLibelle(dateProduction.getDate(), Constantes.PARAMETRE_LIBELLE_COUT_HORAIRE_CNSS);
							  		  		    ...
							  		  		    //	int key=lsiteInt.get(i);
				  		  		    		        ...
				  		  		    		        detailResponsableProd.setCoutHoraireSupp25(heure.getValeur().multiply(new BigDecimal(1.25)));
				  		  		    	            detailResponsableProd.setCoutHoraireSupp50(heure.getValeur().multiply(new BigDecimal(1.5)));
							  		  		    		...
							  		  		    		if(!txtdelaigenerique.getText().equals(""))
							  		  		    		{
							  		  		    			...
							  		  		    			if(new BigDecimal(txtdelaigenerique.getText()).compareTo(BigDecimal.ZERO)  >0)
							  		  		    			{
							  		  		    					...
							  		  		    					
							  		  		    				{
							  		  		    		    		...
							  		  		    		    		coutSupp25=detailheur25.multiply(heure.getValeur().multiply(new BigDecimal(1.25)));
						  		  		    		    		...
						  		  		    		    		coutSupp50=detailheur50.multiply(heure.getValeur().multiply(new BigDecimal(1.5)));
				  		   ...
				  		   lblDateProduction.setBounds(425, 76, 95, 26);
				  		   ...
				  		   dateProduction.setBounds(519, 76, 183, 26);
				  		   add(dateProduction);
				  		   
				  		   JLabel lblNombreProduction = new JLabel("Total Heures Production:");
				  		   lblNombreProduction.setBounds(712, 77, 130, 24);
				  		   add(lblNombreProduction);
				  		   
				  		   txtTotalHeuresProduction = new JTextField();
				  		   txtTotalHeuresProduction.setColumns(10);
				  		   txtTotalHeuresProduction.setBounds(833, 76, 86, 26);
				  		   add(txtTotalHeuresProduction);
				  		   ...
				  		   comboDepot.setBounds(86, 78, 145, 24);
				  		   add(comboDepot);
				  		   
				  		   JLabel label_6 = new JLabel("P\u00E9riode :");
				  		   label_6.setFont(new Font("Tahoma", Font.PLAIN, 12));
				  		   label_6.setBounds(241, 78, 77, 24);
				  		   add(label_6);
				  		   
				  		    comboPeriode = new JComboBox();
				  		   comboPeriode.setBounds(301, 79, 114, 24);
				  		   add(comboPeriode);
				     	...
				     	comboPeriode.addItem(PRPDUCTION_PERIODE_SOIR);
				   		...
				   		btnInitialiser.setBounds(1176, 77, 97, 24);
				   		add(btnInitialiser);
				   		
				   		JLabel lblNombreProduction_1 = new JLabel("Nombre Production:");
				   		lblNombreProduction_1.setBounds(929, 77, 106, 24);
				   		add(lblNombreProduction_1);
				   		
				   		txtNombreProduction = new JTextField();
				   		txtNombreProduction.setText((String) null);
				   		txtNombreProduction.setColumns(10);
				   		txtNombreProduction.setBounds(1031, 76, 95, 26);
...
public	void Initialiser()
	{
		...
		txtTotalHeuresProduction.setText("");
