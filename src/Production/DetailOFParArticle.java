...
afficher_tableProd(listProduction);
		...
		btnImprimer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				TotalCoutEmployerResponsableParProduction=(coutTotalEmployeGenerique.add(coutTotalSupp25EmployeGenerique).add(coutTotalSupp50EmployeGenerique)).divide(TotalHeuresProduction, 6, RoundingMode.HALF_UP);
				
				coutTotalEmployeGenerique=coutTotalEmployeGenerique.divide(TotalHeuresProduction, 6, RoundingMode.HALF_UP);
				coutTotalSupp25EmployeGenerique=coutTotalSupp25EmployeGenerique.divide(TotalHeuresProduction, 6, RoundingMode.HALF_UP);
				coutTotalSupp50EmployeGenerique=coutTotalSupp50EmployeGenerique.divide(TotalHeuresProduction, 6, RoundingMode.HALF_UP);
				...
				txtCoutTotalEmployeGenerique.setText(dfDecimal.format((coutTotalEmployeGenerique.multiply(production.getNbreHeure())).setScale(2, RoundingMode.HALF_UP))+"");
				...
				txttotalcoutsupp25employegenerique.setText(dfDecimal.format((coutTotalSupp25EmployeGenerique.multiply(production.getNbreHeure())).setScale(2, RoundingMode.HALF_UP))+"");
				txttotalcoutsupp50employegenerique.setText(dfDecimal.format((coutTotalSupp50EmployeGenerique.multiply(production.getNbreHeure())).setScale(2, RoundingMode.HALF_UP))+"");
				...
				txtCoutTotal.setText( dfDecimal.format((coutTotalCoutQuantiteConsommeMP.setScale(2, RoundingMode.HALF_UP).add(coutTotalDechetMP.setScale(2, RoundingMode.HALF_UP).add(coutTotalDechetFournisseurMP.setScale(2, RoundingMode.HALF_UP)).add(coutTotalOffreMP.setScale(2, RoundingMode.HALF_UP).add(coutTotalManquanteMP.setScale(2, RoundingMode.HALF_UP))))).add((coutTotalEmployeGenerique.multiply(production.getNbreHeure())).setScale(2, RoundingMode.HALF_UP)).add(coutTotalEmployeProduction.setScale(2, RoundingMode.HALF_UP)).add(coutTotalEmployeEmballage.setScale(2, RoundingMode.HALF_UP).add(coutTotalSupp25EmployeEmballage.setScale(2, RoundingMode.HALF_UP).add(coutTotalSupp25EmployeProduction.setScale(2, RoundingMode.HALF_UP).add(coutTotalSupp25EmployeGenerique.multiply(production.getNbreHeure()).setScale(2, RoundingMode.HALF_UP).add(coutTotalSupp50EmployeGenerique.multiply(production.getNbreHeure())).add(coutTotalSupp50EmployeProduction.setScale(2, RoundingMode.HALF_UP).add(coutTotalSupp50EmployeEmballage.setScale(2, RoundingMode.HALF_UP))))))))+"");
				txtPrix.setText(((coutTotalCoutQuantiteConsommeMP.setScale(2, RoundingMode.HALF_UP).add(coutTotalDechetMP.setScale(2, RoundingMode.HALF_UP).add(coutTotalDechetFournisseurMP.setScale(2, RoundingMode.HALF_UP)).add(coutTotalOffreMP.setScale(2, RoundingMode.HALF_UP).add(coutTotalManquanteMP.setScale(2, RoundingMode.HALF_UP))))).add((coutTotalEmployeGenerique.multiply(production.getNbreHeure())).setScale(2, RoundingMode.HALF_UP)).add(coutTotalEmployeProduction.setScale(2, RoundingMode.HALF_UP)).add(coutTotalEmployeEmballage.setScale(2, RoundingMode.HALF_UP)).add(coutTotalSupp25EmployeEmballage.setScale(2, RoundingMode.HALF_UP).add(coutTotalSupp25EmployeProduction.setScale(2, RoundingMode.HALF_UP).add(coutTotalSupp50EmployeEmballage.setScale(2, RoundingMode.HALF_UP).add(coutTotalSupp50EmployeProduction.setScale(2, RoundingMode.HALF_UP).add((coutTotalSupp25EmployeGenerique.multiply(production.getNbreHeure())).setScale(2, RoundingMode.HALF_UP).add((coutTotalSupp50EmployeGenerique.multiply(production.getNbreHeure())).setScale(2, RoundingMode.HALF_UP)))))))) .divide(production.getQuantiteReel(), 2, RoundingMode.HALF_UP)+"");
