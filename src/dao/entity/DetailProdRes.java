...
public class DetailProdRes implements Serializable {
	...
	@Column(name="TOTAL_HEURES_PRODUCTION")
	private BigDecimal totalHeuresProduction;
	...
	public BigDecimal getTotalHeuresProduction() {
		return totalHeuresProduction;
	}


	public void setTotalHeuresProduction(BigDecimal totalHeuresProduction) {
		this.totalHeuresProduction = totalHeuresProduction;
	}
