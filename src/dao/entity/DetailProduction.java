 ...
 */
@Entity
@Table(name="detail_production")
@NamedQuery(name="DetailProduction.findAll", query="SELECT d FROM DetailProduction d")
public class DetailProduction implements Serializable {
