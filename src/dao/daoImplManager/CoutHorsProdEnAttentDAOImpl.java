...
public List<CoutHorsProdEnAttent>  findBydateByDepotGroupByEmploye(Date datedebut , Depot depot) {
	
	// TODO Auto-generated method stub
	Query query= session.createQuery("select  c from CoutHorsProdEnAttent c  where depot.id=:depot and dateSituation =:datedebut  group by employe");
