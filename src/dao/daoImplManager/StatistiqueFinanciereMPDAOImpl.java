...
public class StatistiqueFinanciereMPDAOImpl implements StatistiqueFinanciereMPDAO {
	...
	@Override
	public List<StatistiqueFinanciaireMP> listeStatistiqueFinanciereMPLimitByCodeTransfertByEtaTransfert(String code, String etatTransfert) {
		// TODO Auto-generated method stub
		Query query= session.createQuery("select c from StatistiqueFinanciaireMP c where   c.id<=(select s.id from StatistiqueFinanciaireMP s where  s.CodeTransfer=:code  and  s.etatTransfer=:etatTransfert) ");
		query.setParameter("code", code);
		query.setParameter("etatTransfert", etatTransfert);
		return query.list();
	...
	@Override
	public StatistiqueFinanciaireMP StatistiqueFinanciereMPByCodeTransfertByEtaTransfert(String code, String etatTransfert) {
		// TODO Auto-generated method stub
		Query query= session.createQuery("select c from StatistiqueFinanciaireMP c where  c.CodeTransfer=:code  and  c.etatTransfer=:etatTransfert");
		query.setParameter("code", code);
		query.setParameter("etatTransfert", etatTransfert);
