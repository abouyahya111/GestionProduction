...
public class ConsulterReceptionsDechet extends JLayeredPane implements Constantes{
	...
	private JTextField txtCodeMP;
	 ...
	 JComboBox comboCodeReception = new JComboBox();
	 private List<TransferStockMP> listcodeReception=new ArrayList<TransferStockMP>();
	/**
	 ...
	 */
	public ConsulterReceptionsDechet() {
		setOpaque(true);
        ...
        try{
        	...
        	listcodeReception=transferStockMPDAO.listTransferByStatutByLikeCodeTransfert(Constantes.ETAT_TRANSFER_STOCK_AJOUT, Constantes.TYPE_DECHET+"_");
       ...
       comboMagasinDestination=new JComboBox();
        ...
        try{
            ...
            imgValider=new ImageIcon(this.getClass().getResource("/img/valider.png"));
					        ...
					        util.Utils.copycollercell(textField);
				  		     	...
				  		     	scrollPane.setBounds(9, 200, 1274, 343);
				  		     	add(scrollPane);
					  	    ...
					  	    comboDepotSource.addItemListener(new ItemListener() {
				  		     	...
				  		     	titledSeparator.setTitle("  HISTORIQUE RECEPTION DECHET");
				  		     	titledSeparator.setBounds(9, 171, 1274, 30);
				  		     	add(titledSeparator);
				  		     	
				  		     	JLayeredPane layeredPane = new JLayeredPane();
				  		     	layeredPane.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
				  		     	layeredPane.setBounds(9, 25, 1238, 111);
				  		     	add(layeredPane);
				  		     	 
				  		 
				  		  comboMagasinDestination.setBounds(278, 28, 268, 24);
				  		  ...
				  		  JLabel lblCodeTransfer = new JLabel("Code Reception");
				  		  lblCodeTransfer.setBounds(541, 64, 81, 24);
				  		  ...
				  		  dateTransfereChooserau.setBounds(854, 29, 144, 26);
        ...
        String requete="";
				...
				if(!comboCodeReception.getSelectedItem().toString().equals(""))
				{
					requete= requete+" and transferStockMP.CodeTransfer='"+comboCodeReception.getSelectedItem().toString()+"'";
				}
				...
				listDetailTransfertMP=detailTransferMPDAO.ListHistoriqueReceptionDechet(requete);
	  ...
	  if(!utilisateur.getCodeDepot().equals(CODE_DEPOT_SIEGE)	) {
		...
		txtCodeMP.setText(Constantes.CODE_MP);
		  ...
		  comboCodeReception = new JComboBox();
		comboCodeReception.setBounds(632, 66, 286, 24);
		layeredPane.add(comboCodeReception);
		comboCodeReception.addItem("");
		for(int t=0;t<listcodeReception.size();t++)
			{
			
			comboCodeReception.addItem(listcodeReception.get(t).getCodeTransfer());
			
			
			}
			
		comboCodeReception.setSelectedItem("");
			 ...
			 int i=0;
				...
				{	
					...
					if(detailTransferStockMP.getFournisseur()!=null)
					{
						...
						Object []ligne={detailTransferStockMP.getTransferStockMP().getDateTransfer(),detailTransferStockMP.getTransferStockMP().getCodeTransfer(), detailTransferStockMP.getMatierePremier().getCode(), detailTransferStockMP.getMatierePremier().getNom(),fournisseur, NumberFormat.getNumberInstance(Locale.FRANCE).format(detailTransferStockMP.getQuantite())};
...
void intialiserTableau(){
	...
	modeleMP =new DefaultTableModel(
		     	...
		     	new String[] {
		     		"Date reception","Code Reception","Code","Nom MP","Fournisseur","Quantité"
		     	}
		     ) {
