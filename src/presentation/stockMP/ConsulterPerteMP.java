...
public class ConsulterPerteMP extends JLayeredPane implements Constantes{
	...
	public ConsulterPerteMP() {
       ...
       System.exit(0);
        ...
        try{
		 ...
		 btnValider.setBounds(589, 735, 104, 31);
		 add(btnValider);
...
int i=0;
  ...
  btnRechercher.addActionListener(new ActionListener() {
  	public void actionPerformed(ActionEvent arg0) {
  		...
  		listPerteMP.clear();
  			...
  			PerteMP perteMP=PerteMPDAO.findByDateByMagasinByNumPerte(numbon,dateChooserdechet.getDate(), magasindechet);
  ...
  scrollPane.setBounds(10, 371, 1423, 336);
  add(scrollPane);
  ...
  scrollPane_1.setBounds(9, 76, 1412, 263);
  add(scrollPane_1);
  ...
  btnVider.setBounds(1442, 67, 113, 31);
  add(btnVider);
  for(int j=0;j<listActionMP.size();j++)
  {
	...
	public void ChargerNumBonPerteMPValider()
	{
		...
		comboNumBon.addItem("");
		listePerteMP=PerteMPDAO.listDesPertesParDepot(AuthentificationView.utilisateur.getCodeDepot());
