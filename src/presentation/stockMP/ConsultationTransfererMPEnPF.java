...
import dao.entity.EtatTransfertMPEnPF;
...
public class ConsultationTransfererMPEnPF extends JLayeredPane implements Constantes{
	 ...
	 private DetailTypeSortieDAO detailTypeSortieDAO;
		...
		private SubCategorieMPDAO subcategoriempdao;
		 JButton btnAfficherStock = new JButton("");
			...
			List<EtatTransfertMPEnPF> listEtatTransfertStockMPEnPF= new ArrayList<EtatTransfertMPEnPF>();
	/**
	 ...
	 */
	public ConsultationTransfererMPEnPF() {
		setOpaque(true);
            ...
            imgImprimer = new ImageIcon(this.getClass().getResource("/img/imprimer.png"));
				  		     ...
				  		     table.addMouseListener(new MouseAdapter() {
				  		     	...
				  		     	public void mouseClicked(MouseEvent arg0) {
				  		     		...
				  		     		{
				  		     			listEtatTransfertStockMPEnPF.clear();
				  		     			
				  		     			DetailTransferStockMP detailTransferStockMP=listDetailTransferStockMP.get(table.getSelectedRow());
				  		     			if(detailTransferStockMP!=null)
				  		     			{
				  		     				
				  		     				listDetailTransferStockMPTmp=detailTransferStockMPDAO.findByTransferStockMP(detailTransferStockMP.getTransferStockMP().getId());
				  		     				...
				  		     				if(transferStockPF!=null)
				  		     				{
					  		     				...
					  		     				{
					  		     					DetailTransferStockMP detaiTransferStockMP=listDetailTransferStockMPTmp.get(i);
					  		     					
					  		     					
					  		     					 
					  		     						EtatTransfertMPEnPF etatTransfertMPEnPF=new EtatTransfertMPEnPF();
					  		     						
					  		     						etatTransfertMPEnPF.setCodeTransfert(detaiTransferStockMP.getTransferStockMP().getCodeTransfer());
					  		     						etatTransfertMPEnPF.setMagasinDestination(detaiTransferStockMP.getMagasinDestination());
					  		     						etatTransfertMPEnPF.setMagasinSouce(detaiTransferStockMP.getMagasinSouce());
					  		     						if(detaiTransferStockMP.getFournisseur()!=null)
					  		     						{
					  		     							etatTransfertMPEnPF.setFournisseurMP(detaiTransferStockMP.getFournisseur());
					  		     						}
					  		     						etatTransfertMPEnPF.setQuantiteTransfert(detaiTransferStockMP.getQuantite());
					  		     						etatTransfertMPEnPF.setMp(detaiTransferStockMP.getMatierePremier());
					  		     						listEtatTransfertStockMPEnPF.add(etatTransfertMPEnPF);
				  		     				...
				  		     				afficher_tableDetailMP(listEtatTransfertStockMPEnPF);
	  		  	...
	  		  	lblFournisseur.setVisible(false);
				  		...
				  		listDetailTransferStockMP=detailTransferStockMPDAO.listDetailTransferStockMPEnPFByReq(req);
		  ...
		  int i=0;
			...
			{	
				...
				DetailTransferStockMP detailTransferStockMP=  listDetailTransfertMP.get(i);
						...
						Object []ligne={detailTransferStockMP.getTransferStockMP().getCodeTransfer(),detailTransferStockMP.getTransferStockMP().getDateTransfer(),detailTransferStockMP.getTransferStockMP().getStatut()};
	...
	void afficher_tableDetailMP(List<EtatTransfertMPEnPF> listEtatTransfertMPEnPF)
	{
		...
		intialiserDetailTransfertMP();
		  ...
		  int i=0;
			while(i<listEtatTransfertMPEnPF.size())
			{	
				
			 String fournisseur="";
			 EtatTransfertMPEnPF EtatTransfertMPEnPF=  listEtatTransfertMPEnPF.get(i);
					 
						if(EtatTransfertMPEnPF.getFournisseurMP()!=null)
						{
							fournisseur=EtatTransfertMPEnPF.getFournisseurMP().getCodeFournisseur();
						}
						Object []ligne={EtatTransfertMPEnPF.getMp().getCode(),EtatTransfertMPEnPF.getMp().getNom(),fournisseur,EtatTransfertMPEnPF.getQuantiteTransfert(),EtatTransfertMPEnPF.getMagasinSouce().getLibelle(),EtatTransfertMPEnPF.getMagasinDestination().getLibelle()};
