...
public class ConsulterEtatStockDechetMP extends JLayeredPane implements Constantes {
	...
	public ConsulterEtatStockDechetMP() {
		...
		tableEtatStock.setModel(new DefaultTableModel(new Object[][] {},
				new String[] {  "Code","Matiere Premiere","INITIAL", "RECEPTION","DECHET USINE", "DECHET FOURNISSEUR", "PERTE","VENTE","Retour Dechet Fournisseur En Attent","Retour Dechet Fournisseur Annulé","Autres Sortie",
						  "Quantite Finale" }));
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
					"Code","Matiere Premiere","INITIAL", "RECEPTION","DECHET USINE", "DECHET FOURNISSEUR", "PERTE","Retour Dechet Fournisseur En Attent","Retour Dechet Fournisseur Définitive ","Retour Dechet Fournisseur Annulé","VENTE","Autres Sortie",
					  "Quantite Finale"			}
		));
...
existe=false;
	...
	void afficher_tableEtatStock(List<EtatStockDechetMP> listEtatStockMP) {
		modeleEtatStock = new DefaultTableModel(new Object[][] {},
				new String[] {  "Code","Matiere Premiere","INITIAL", "RECEPTION","DECHET USINE", "DECHET FOURNISSEUR", "PERTE","Retour Dechet Fournisseur En Attent","Retour Dechet Fournisseur Définitive ","Retour Dechet Fournisseur Annulé","VENTE","Autres Sortie",
						  "Quantite Finale" }) {
	...
	void afficher_tableDetailEtatStock(List<EtatStockDechetMP> listEtatStockMP) {
		modeleDetailEtatStock = new DefaultTableModel(new Object[][] {},
				new String[] {  "Code","Matiere Premiere","FOURNISSEUR","INITIAL", "RECEPTION","DECHET USINE", "DECHET FOURNISSEUR", "PERTE","Retour Dechet Fournisseur En Attent","Retour Dechet Fournisseur Définitive ","Retour Dechet Fournisseur Annulé","VENTE","Autres Sortie",
						  "Quantite Finale" }) {
