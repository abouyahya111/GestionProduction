...
for(int i=0;i<listeDetailTransfertStockPF.size();i++)
{
	
	
	CoutArticlePF coutArticlePF=coutArticlePFDAO.CoutArticlePFByArticle(listeDetailTransfertStockPF.get(i).getArticle());
	...
	coutArticlePF.setCoutEquipeGenerique(coutArticlePF.getCoutEquipeGenerique().add(BigDecimal.ZERO));
	coutArticlePF.setCoutEquipeEmballage(coutArticlePF.getCoutEquipeEmballage().add(BigDecimal.ZERO));
	coutArticlePF.setCoutEquipeProduction(coutArticlePF.getCoutEquipeProduction().add(BigDecimal.ZERO));
	coutArticlePF.setCoutMP(coutArticlePF.getCoutMP().add(listeDetailTransfertStockPF.get(i).getQuantite().multiply(listeDetailTransfertStockPF.get(i).getPrixUnitaire())) );
	coutArticlePF.setQuantiteRealiser(coutArticlePF.getQuantiteRealiser().add(listeDetailTransfertStockPF.get(i).getQuantite()) );
	...
	detailCoutArticlePF.setArticles(listeDetailTransfertStockPF.get(i).getArticle());
	detailCoutArticlePF.setCoutEquipeGenerique(BigDecimal.ZERO);
	detailCoutArticlePF.setCoutEquipeEmballage(BigDecimal.ZERO);
	detailCoutArticlePF.setCoutEquipeProduction(BigDecimal.ZERO);
	detailCoutArticlePF.setCoutMP(listeDetailTransfertStockPF.get(i).getQuantite().multiply(listeDetailTransfertStockPF.get(i).getPrixUnitaire()));
	detailCoutArticlePF.setQuantiteRealiser(listeDetailTransfertStockPF.get(i).getQuantite());
	...
	detailCoutArticlePF.setDate(listeDetailTransfertStockPF.get(i).getDateTransfer());	
	detailCoutArticlePF.setCodeTransfer(transferStock.getCodeTransfer());
	...
	coutArticlePFTmp.setArticles(listeDetailTransfertStockPF.get(i).getArticle());
	coutArticlePFTmp.setCoutEquipeGenerique(BigDecimal.ZERO);
	coutArticlePFTmp.setCoutEquipeEmballage(BigDecimal.ZERO);
	coutArticlePFTmp.setCoutEquipeProduction(BigDecimal.ZERO);
	coutArticlePFTmp.setCoutMP(listeDetailTransfertStockPF.get(i).getQuantite().multiply(listeDetailTransfertStockPF.get(i).getPrixUnitaire()));
	coutArticlePFTmp.setQuantiteRealiser(listeDetailTransfertStockPF.get(i).getQuantite());
		  			...
		  			if(listecategoriemp!=null)
		  			{
		  				while(i<listecategoriemp.size())
		  				{
		  					if(utilisateur.getType()!=null)
  							{
  								...
  								{
  									if(listecategoriemp.get(i).getSubCategorieMp().getCode().equals(Constantes.SOUS_CATEGORIE_MATIERE_PREMIERE_THE))
  									{
