		...
		btnAfficherStock.addActionListener(new ActionListener() {
			...
			if(comboDepot.getSelectedItem().equals(""))	{
		    	...
		    	Client client=null;
		    			...
		    			listDetailTransferStockPFReception=detailTransferStockPFDAO.ListTransferStockPFEntreDeuxDatesBYPFStatutReception(datedebut, dateChooserfin.getDate(), article, Constantes.ETAT_TRANSFER_STOCK_SORTIE,magasin,client);
		    			listDetailTransferStockPFReceptionGroupebyPF=detailTransferStockPFDAO.ListTransferStockPFEntreDeuxDatesBYPFDistinctByStatutReception(datedebut, dateChooserfin.getDate(), article, Constantes.ETAT_TRANSFER_STOCK_SORTIE,magasin,client);
