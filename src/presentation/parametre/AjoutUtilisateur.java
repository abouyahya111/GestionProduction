	      		...
	      		{	
	      			...
	      			i++;
					  		   	...
					  		   	if(txtNom.getText().equals(""))
			  		     			...
			  		     			if (!txtMdp.getText().equals(txtConfirmMdP.getText())){
			  		     				JOptionPane.showMessageDialog(null, "Les mots ne sont pas identiques!", "Attention", JOptionPane.INFORMATION_MESSAGE);
						  		  		...
						  		  		{
						  		  		utilisateur.setType(comboType.getSelectedItem().toString());
						  		  		}
				  		...
				  		btnAjouter.setIcon(imgAjouter);
				  		 ...
				  		 btnAjouter.setBounds(137, 281, 114, 26);
				  		 add(btnAjouter);
				  		...
				  		btnInitialiser.setIcon(imgInit);
				  		 ...
				  		 btnInitialiser.setBounds(261, 281, 112, 26);
				  		 add(btnInitialiser);
				  		 ...
				  		 JLayeredPane layeredPane = new JLayeredPane();
				  		   ...
				  		   layeredPane.setBounds(30, 23, 565, 247);
				  		   add(layeredPane);
				  		 ...
				  		 util.Utils.copycoller(txtNom);
				  		   ...
				  		   lblNomUtilisateur.setFont(new Font("Tahoma", Font.PLAIN, 12));
				  		   		...
				  		   		util.Utils.copycoller(txtConfirmMdP);
				  		   			...
				  		   			lblType.setBounds(9, 210, 130, 26);
				  		   			layeredPane.add(lblType);
				  		   			
				  		   			  comboType = new JComboBox();
				  		   			comboType.setBounds(152, 211, 191, 26);
				  		   			...
				  		   			btnGnrerMenu.addActionListener(new ActionListener() {
				  		   				public void actionPerformed(ActionEvent e) {
				  		   				Utils.genererMenuUtilisateur();
				  		   				JOptionPane.showMessageDialog(null, "Menu Genere Avec SuccÈe");
				  		   				}
				  		   			});
				  		   			btnGnrerMenu.setBounds(394, 283, 114, 23);
				  		   			add(btnGnrerMenu);
				  		   			
				  		   		comboType.addItem("");
				  		   	comboType.addItem(Constantes.UTILISATEUR_SORTIE_ENVRAC);
				  		  comboType.addItem(Constantes.UTILISATEUR_EMBALLAGE);
				  			comboType.addItem(Constantes.UTILISATEUR_SORTIE_PRODUCTION);
