							 ...
							 Parametre parametreNbrHeuresTotal=parametreDAO.findByLibelle(Constantes.NBR_HEURES_TOTAL);
			        		  ...
			        		  String date="";
			        			...
			        			{	
			        				...
			        				coutHeureSupp25=coutHeurs.multiply(new BigDecimal(1.25)).multiply(ficheEmployeTmp.getHeureSupp25());
			        				coutHeureSupp50=coutHeurs.multiply(new BigDecimal(1.5)).multiply(ficheEmployeTmp.getHeureSupp50());
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////								 
								 ...
								 totalHoraire=totalHoraire.setScale(2, RoundingMode.HALF_UP);
		...
		btnExporterExcel.setBounds(1140, 553, 136, 24);
...
////////////////////////////////////////////////////////////////  Ajouter Fiche Employee  ///////////////////////////////////////////////////////////////////////////////////////////								
	...
	///////////////////////////////////////////////////////////////////////// Impression   /////////////////////////////////////////////////////////////////////////////////////////		                    
			                    ...
			                    parametersTmp.put("PRIME_APAYER", primeAPayer);
			                    DecimalFormat formatNumber = new DecimalFormat("#.00");
			                	 
			                    String netapayerAfficher=formatNumber.format(netapayer);
			                  if(netapayer.compareTo(BigDecimal.ZERO)==0)
			                  {
			                	  netapayerAfficher="0,00";
			                	  System.out.println("nete a payer egal a 0 : "+netapayer);
			                  }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////								 
								...
								InputStream str =JasperUtils.class.getResourceAsStream("/jasper/BulltinPaieEmployeSansPrime.jasper");
		...
		btnBulletinPaieSans.setIcon(new ImageIcon(ImpressionFicheEmployeeEtBuletin.class.getResource("/img/imprimer.png")));
		btnBulletinPaieSans.setBounds(946, 554, 184, 24);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	for(int i=0;i<listDetailProdGenerique.size();i++){
		...
		coutHoraire=detailProdGen.getCoutHoraire().multiply(delai);
		coutSupp25=heureSupp25.multiply(detailProdGen.getCoutHoraire().multiply(new BigDecimal(1.25)));
		coutSupp50=heureSupp50.multiply(detailProdGen.getCoutHoraire().multiply(new BigDecimal(1.25)));
