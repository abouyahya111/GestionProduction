...
import presentation.stockMP.ConsulterTotalReceptionsEnAttente;
...
import presentation.stockMP.ImporterReceptions;
...
import presentation.stockPF.ConsulterSortiePF;
import presentation.stockPF.SortirStockPF;
import presentation.stockPF.ValidationSortiePF;
...
import Equipe.ConsulterEmployeesTravailParJournnee;
...
import Production.AjouterNombrePersonneTravailerDansLaProduction;
...
import Production.CoutProductionParArticleCalculable;
import Production.CoutProductionParArticleStocker;
...
import Production.ModifierHeuresEmployeeProductionTerminer;
...
import ProductionCarton.DetailOFCarton;
import ProductionCarton.LancerOrdreFabricationMP;
import ProductionCarton.ModifierHeuresEmployeeProductionCarton;
...
import Referentiel.ListeCodeMPParArticle;
import Referentiel.ListeEstimationMPParArticle;
...
public class Main extends JFrame implements Constantes{
    	...
    	private JMenu situationFinanciereMenu;
        ...
        public Main(){
           ...
           btnDeconnexion = new JButton(new ImageIcon(this.getClass().getResource("/img/deconnect.png")));
            ...
            userLoginPanel.setBounds(1475, 965, 189, 20);
...
menubar.add(MatierePremierMenu); 
          ...
          menubar.add(articleMenu);  
           ...
           JMenuItem listeCodeMPParARticleMenuItem = new JMenuItem("Afficher Liste Code MP Par Article PF");
           listeCodeMPParARticleMenuItem.setMnemonic(KeyEvent.VK_A);
           articleMenu.add(listeCodeMPParARticleMenuItem);
           listeCodeMPParARticleMenuItem.addActionListener(new ActionListener() {
                                                               public void actionPerformed(ActionEvent event) {
                                                               	title.setText("Afficher Liste Code MP Par Article PF");
                                                               	titlePanel.add(title);
                                                               	contentPane  = new ListeCodeMPParArticle();
           ...
           JMenuItem listeEstimationMPParARticleMenuItem = new JMenuItem("Afficher Liste Estimation MP Par Article PF");
           listeEstimationMPParARticleMenuItem.setMnemonic(KeyEvent.VK_A);
           articleMenu.add(listeEstimationMPParARticleMenuItem);
           listeEstimationMPParARticleMenuItem.addActionListener(new ActionListener() {
                                                               public void actionPerformed(ActionEvent event) {
                                                               	title.setText("Afficher Liste Estimation MP Par Article PF");
                                                               	titlePanel.add(title);
                                                               	contentPane  = new ListeEstimationMPParArticle();
          ...
          */
           ...
           */
           ...
           JMenuItem listeDesEmployeeTravailParJournneeMenuItem = new JMenuItem("Liste De Employees Travail Par Journnee");
           listeDesEmployeeTravailParJournneeMenuItem.setName("listeDesEmployeeTravailParJournneeMenuItem");
           listeDesEmployeeTravailParJournneeMenuItem.setMnemonic(KeyEvent.VK_A);
           equipeFabMenu.add(listeDesEmployeeTravailParJournneeMenuItem);
           listeDesEmployeeTravailParJournneeMenuItem.addActionListener(new ActionListener() {
                                                               public void actionPerformed(ActionEvent event) {
                                                               	title.setText("Liste De Employees Travail Par Journnee");
                                                               	titlePanel.add(title);
                                                               	contentPane  = new ConsulterEmployeesTravailParJournnee();
           ...
           lancerorderfabricationmpMenuItem.addActionListener(new ActionListener() {
            ...
            JMenuItem ConsulterDetailOFCartonMenuItem = new JMenuItem("Consulter Detail OF Carton");
            ConsulterDetailOFCartonMenuItem.setName("ConsulterDetailOFCartonMenuItem");
            ConsulterDetailOFCartonMenuItem.setMnemonic(KeyEvent.VK_A);
            prodCartMenu.add(ConsulterDetailOFCartonMenuItem);
            ConsulterDetailOFCartonMenuItem.addActionListener(new ActionListener() {
                                                                public void actionPerformed(ActionEvent event) {
                                                                	title.setText("Consulter Detail OF Carton");
                                                                	titlePanel.add(title);
                                                                	contentPane  = new  DetailOFCarton();
            ...
            JMenuItem ModifierHeuresEmployeecartonMenuItem = new JMenuItem("Modifier Heures Employee production Carton");
            ModifierHeuresEmployeecartonMenuItem.setName("ModifierHeuresEmployeecartonMenuItem");
            ModifierHeuresEmployeecartonMenuItem.setMnemonic(KeyEvent.VK_A);
            prodCartMenu.add(ModifierHeuresEmployeecartonMenuItem);
            ModifierHeuresEmployeecartonMenuItem.addActionListener(new ActionListener() {
                                                                public void actionPerformed(ActionEvent event) {
                                                                	title.setText("Modifier Heures Employee production Carton");
                                                                	titlePanel.add(title);
                                                                	contentPane  = new  ModifierHeuresEmployeeProductionCarton( null, "","");
            ...
            JMenuItem ajouterNombrePersonnesTravaillerParProductionMenuItem = new JMenuItem("Ajouter Nombre Personnes Travailler Par production");
            ajouterNombrePersonnesTravaillerParProductionMenuItem.setName("ajouterNombrePersonnesTravaillerParProductionMenuItem");
            ajouterNombrePersonnesTravaillerParProductionMenuItem.setMnemonic(KeyEvent.VK_A);
            ordreFabMenu.add(ajouterNombrePersonnesTravaillerParProductionMenuItem);
            ajouterNombrePersonnesTravaillerParProductionMenuItem.addActionListener(new ActionListener() {
                                                                public void actionPerformed(ActionEvent event) {
                                                                	title.setText("Ajouter Nombre Personnes Travailler Par production");
                                                                	titlePanel.add(title);
                                                                	contentPane  = new AjouterNombrePersonneTravailerDansLaProduction();
        ...
        //   ordreFabMenu.add(afficherCoutDechetMenuItem);
           ...
           JMenuItem modifierLesHeuresEmployeeProductionMenuItem = new JMenuItem("Modifier Les Heures Des Employees Production PF");
           modifierLesHeuresEmployeeProductionMenuItem.setName("modifierLesHeuresEmployeeProductionMenuItem");
           modifierLesHeuresEmployeeProductionMenuItem.setMnemonic(KeyEvent.VK_A);
           ordreFabMenu.add(modifierLesHeuresEmployeeProductionMenuItem);
           modifierLesHeuresEmployeeProductionMenuItem.addActionListener(new ActionListener() {
                                                               public void actionPerformed(ActionEvent event) {
                                                               	title.setText("Modifier Les Heures Des Employees Production PF");
                                                               	titlePanel.add(title);
                                                               	contentPane  = new ModifierHeuresEmployeeProductionTerminer(null, "","");
            ...
            ajouterStockMenuItem.setName("AjouterReceptionMPMenuItem");
            ...
            JMenuItem ImporterStockMenuItem = new JMenuItem("Importer Reception MP");
            ImporterStockMenuItem.setName("ImporterReceptionMenuItem");
            ImporterStockMenuItem.setMnemonic(KeyEvent.VK_A);
            ReceptionMPMenu.add(ImporterStockMenuItem);
            ImporterStockMenuItem.addActionListener(new ActionListener() {
                                                                public void actionPerformed(ActionEvent event) {
                                                                	title.setText("Importer Reception MP");
                                                                	titlePanel.add(title);
                                                                	contentPane  = new ImporterReceptions();
            ...
            historiqueReceptionStockMenuItem.setName("ConsultationDetailReceptionMPMenuItem");
            ...
            historiqueReceptionTotalStockMenuItem.setName("ConsultationGlobalReceptionMPMenuItem");
            ...
            JMenuItem historiqueReceptionTotalStockEnAttenteMenuItem = new JMenuItem("Consultation Global Reception MP EN ATTENTE");
            historiqueReceptionTotalStockEnAttenteMenuItem.setName("ConsultationGlobalReceptionMPENATTENTEMenuItem");
            historiqueReceptionTotalStockEnAttenteMenuItem.setMnemonic(KeyEvent.VK_A);
            ReceptionMPMenu.add(historiqueReceptionTotalStockEnAttenteMenuItem);
            historiqueReceptionTotalStockEnAttenteMenuItem.addActionListener(new ActionListener() {
                                                                public void actionPerformed(ActionEvent event) {
                                                                	title.setText("Consultation Global Reception MP EN ATTENTE");
                                                                	titlePanel.add(title);
                                                                	contentPane  = new ConsulterTotalReceptionsEnAttente();
         ...
         */
           ...
           */
             ...
             afficherPFMenuItem.addActionListener(new ActionListener() {
              ...
              JMenuItem ConsultersortirPFMenuItem = new JMenuItem("Consulter Sortir Stock Produit Fini");
              ConsultersortirPFMenuItem.setName("ConsultersortirPFMenuItem");
              ConsultersortirPFMenuItem.setMnemonic(KeyEvent.VK_A);     
              stockPFMenu.add(ConsultersortirPFMenuItem);
              ConsultersortirPFMenuItem.addActionListener(new ActionListener() {
                                                                  public void actionPerformed(ActionEvent event) {
                                                                  	title.setText("Consulter Sortir Stock Produit Fini");
                                                                  	titlePanel.add(title);
                                                                  	contentPane  = new ConsulterSortiePF();
              ...
              JMenuItem ValidersortirPFMenuItem = new JMenuItem("Valider Sortir Stock Produit Fini");
              ValidersortirPFMenuItem.setName("ValidersortirPFMenuItem");
              ValidersortirPFMenuItem.setMnemonic(KeyEvent.VK_A);     
              stockPFMenu.add(ValidersortirPFMenuItem);
              ValidersortirPFMenuItem.addActionListener(new ActionListener() {
                                                                  public void actionPerformed(ActionEvent event) {
                                                                  	title.setText("Valider Sortir Stock Produit Fini");
                                                                  	titlePanel.add(title);
                                                                  	contentPane  = new ValidationSortiePF();
              ...
              StatistiqueMenu.setName("StatistiqueMenu");
                ...
                */
                ...
                JMenuItem CoutProductionParArticleStockerMenuItem = new JMenuItem("Liste Des Couts Par Article Stocker");
                CoutProductionParArticleStockerMenuItem.setName("CoutProductionParArticleStockerMenuItem");
                CoutProductionParArticleStockerMenuItem.setMnemonic(KeyEvent.VK_A);
                CoutProductionMenu.add(CoutProductionParArticleStockerMenuItem);
                CoutProductionParArticleStockerMenuItem.addActionListener(new ActionListener() {
                                                                    public void actionPerformed(ActionEvent event) {
                                                                    	title.setText("Liste Des Couts Par Article Stocker");
                                                                    	titlePanel.add(title);
                                                                    	contentPane  = new CoutProductionParArticleStocker();
                ...
                JMenuItem CoutProductionParArticleCalculableMenuItem = new JMenuItem("Liste Des Couts Par Article Calculer");
                CoutProductionParArticleCalculableMenuItem.setName("CoutProductionParArticleMenuItem");
                CoutProductionParArticleCalculableMenuItem.setMnemonic(KeyEvent.VK_A);
                CoutProductionMenu.add(CoutProductionParArticleCalculableMenuItem);
                CoutProductionParArticleCalculableMenuItem.addActionListener(new ActionListener() {
                                                                    public void actionPerformed(ActionEvent event) {
                                                                    	title.setText("Liste Des Couts Par Article Calculer");
                                                                    	titlePanel.add(title);
                                                                    	contentPane  = new CoutProductionParArticleCalculable();
               ...
               situationFinanciereMenu = new JMenu("Situation Financiere");
               menubar.add(situationFinanciereMenu);
               JMenuItem SituationFinanciereMenuItem = new JMenuItem("Consulter Statistiaue Financiere MP");
               SituationFinanciereMenuItem.setMnemonic(KeyEvent.VK_A);
               situationFinanciereMenu.add(SituationFinanciereMenuItem);
               SituationFinanciereMenuItem.addActionListener(new ActionListener() {
                                                                   public void actionPerformed(ActionEvent event) {
                                                                   	title.setText("Consulter Statistiaue Financiere MP");
                                                                   	titlePanel.add(title);
                                                                   	contentPane  = new StatistiqueFinanciereDesMP();
